...
// 返 回 值:   	int
//************************************************************************
int INI_Config::ReadINI(string path)
{
...
//************************************************************************
string INI_Config::GetValue(string root, string key)
{
...
// 返 回 值:   	int
//************************************************************************
int INI_Config::WriteINI(string path)
{
...
//************************************************************************
vector<ININode>::size_type INI_Config::SetValue(string root, string key, string value)
{
